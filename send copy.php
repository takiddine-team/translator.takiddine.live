...
class Translator {
    ...
    public function translate_with_chatGPT($content){
        ...
        sv('--------------------------');
        sv(json_decode($content));
        sv(json_decode( $response['choices'][0]['message']['content'] , true ));
        sv('--------------------------');
